  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: Image.asset('assets/menu-bold_1_.png'),
      ),
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Image.asset('assets/language (1).png'),
                          ),
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Image.asset('assets/Path 410.png'),
                          ),
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: ChoiceChip(
                        ...
                        pressElevation: 0,
                        backgroundColor: Colors.grey[200],
                        avatar: Image.asset('assets/life (1).png'),
                        label: const Text(
                          'Philosophy',
                          style: TextStyle(
                            fontSize: 20,
                      ...
                      child: Stack(
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: Column(
                              children: [
                                Image.asset('assets/Rectangle3 (1).png'),
                                const Text(
                                  'Yebedel Kassa Novel',
                                )
                              ],
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          children: [
                            Image.asset('assets/Rectangle4 (1).png'),
                      ...
                      child: Stack(
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: Column(
                              children: [
                                Image.asset('assets/Rectangle5(1).png'),
                                const Text(
